...
_C.DATASETS.TEST = ()
_C.DATASETS.NUM_CLASSES = 29
_C.DATASETS.WORD_DIM = 300
_C.DATASETS.NEGATIVE_TO_POSITIVE_SAMPLE_RATIO = 3

# How to label the verb for Gegative examples.
# 0--Regard all Neg examples as no-interaction
# 1--Regard all Neg examples as non-annotated
_C.DATASETS.NEG_VERB_ALLZERO = 1
...
_C.MODEL.BACKBONE.FREEZE_CONV_BODY_AT = 4
...
_C.MODEL.ROI_BOX_HEAD.NUM_CLASSES = 27
...
_C.SOLVER.GAMMA = 0.1
# for step learning rate decay
_C.SOLVER.STEPS = (30000,)

# for exponential decay parameter
_C.SOLVER.STEPSIZE = 100000
...
_C.SOLVER.TEST_PERIOD = 20000 # 10000 #@Done change test_period here

_C.SOLVER.SUMMARY_INTERVAL = 10000
...
# For reproducibility
_C.TEST.RNG_SEED = 0 # 3

# When test during training, the test threshold
_C.TEST.HUMAN_THRESHOLD = 0.8
_C.TEST.OBJECT_THRESHOLD = 0.1

# ---------------------------------------------------------------------------- #
# Misc options
# ---------------------------------------------------------------------------- #
_C.OUTPUT_DIR = "./output"
_C.TB_DIR = "./output/tensorboard"
